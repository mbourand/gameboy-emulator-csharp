...
public class OperatorOffsettedLD : CPUOperator {
	protected DataTypeOffsettedReg16 _sourceDataType;
	protected OperationDataType _destinationDataType;

	public OperatorOffsettedLD(DataTypeOffsettedReg16 sourceDataType, OperationDataType destinationDataType) : base("LD", 1) {
