...
public class TestOR : Test {
	...
	public static void RunOperation(Gameboy gameboy, OperationDataType source, OperationDataType destination, ushort sourceValue, ushort destinationValue, ushort expectedOutput, Dictionary<CPUFlag, bool> expectedFlags, FlagPermissionHandler flagPermissionHandler) {
		...
		var operation = new OperatorOR(source, destination, flagPermissionHandler);
	...
	public static void TestORReg8Reg8(CPURegister source, CPURegister destination) {
		var tests = new (byte, byte, Dictionary<CPUFlag, bool>)[]
		{
			...
			(0xFF, 0xFF, new() { {CPUFlag.Zero, false}, {CPUFlag.NSubtract, false}, {CPUFlag.HalfCarry, false}, {CPUFlag.Carry, false} }),
	...
	public static void TestORU8Reg8(CPURegister destination) {
		var tests = new (byte, byte, Dictionary<CPUFlag, bool>)[]
		{
			(0xFF, 0x00, new() { {CPUFlag.Zero, false}, {CPUFlag.NSubtract, false}, {CPUFlag.HalfCarry, false}, {CPUFlag.Carry, false} }),
			(0b01, 0b10, new() { {CPUFlag.Zero, false}, {CPUFlag.NSubtract, false}, {CPUFlag.HalfCarry, false}, {CPUFlag.Carry, false} }),
	...
	public static void TestORReg16AddressReg8(CPURegister source, CPURegister destination, ushort sourceAddress) {
		var tests = new (byte, byte, Dictionary<CPUFlag, bool>)[]
		{
			(0xFF, 0x00, new() { {CPUFlag.Zero, false}, {CPUFlag.NSubtract, false}, {CPUFlag.HalfCarry, false}, {CPUFlag.Carry, false} }),
			(0b01, 0b10, new() { {CPUFlag.Zero, false}, {CPUFlag.NSubtract, false}, {CPUFlag.HalfCarry, false}, {CPUFlag.Carry, false} }),
	...
	public override void Run() {
		TestORReg8Reg8(CPURegister.B, CPURegister.A);
		TestORReg8Reg8(CPURegister.C, CPURegister.A);
		TestORReg8Reg8(CPURegister.D, CPURegister.A);
		TestORReg8Reg8(CPURegister.E, CPURegister.A);
		TestORReg8Reg8(CPURegister.H, CPURegister.A);
		TestORReg8Reg8(CPURegister.L, CPURegister.A);

		TestORReg16AddressReg8(CPURegister.HL, CPURegister.A, Memory.WorkRAMBank0.Address);

		TestORU8Reg8(CPURegister.A);

		Console.WriteLine("All OR tests passed");
	}
