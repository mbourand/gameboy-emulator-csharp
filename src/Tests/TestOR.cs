...
public class TestOR : Test
{
	...
	public void TestORReg8Reg8(CPURegister source, CPURegister destination)
	{
		var tests = new (byte, byte, Dictionary<CPUFlag, bool>)[]
		{
			...
			(0xFF, 0xFF, new() { {CPUFlag.ZERO, false}, {CPUFlag.N_SUBTRACT, false}, {CPUFlag.HALF_CARRY, false}, {CPUFlag.CARRY, false} }),
	...
	public void TestORU8Reg8(CPURegister destination)
	{
		var tests = new (byte, byte, Dictionary<CPUFlag, bool>)[]
		{
			(0xFF, 0x00, new() { {CPUFlag.ZERO, false}, {CPUFlag.N_SUBTRACT, false}, {CPUFlag.HALF_CARRY, false}, {CPUFlag.CARRY, false} }),
	...
	public void TestORReg16AddressReg8(CPURegister source, CPURegister destination, ushort sourceAddress)
	{
		var tests = new (byte, byte, Dictionary<CPUFlag, bool>)[]
		{
			(0xFF, 0x00, new() { {CPUFlag.ZERO, false}, {CPUFlag.N_SUBTRACT, false}, {CPUFlag.HALF_CARRY, false}, {CPUFlag.CARRY, false} }),
	...
	public override void Run()
	{
		...
		TestORReg16AddressReg8(CPURegister.HL, CPURegister.A, Memory.WorkRAMBank0.addr);
